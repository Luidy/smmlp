...
#ifndef SMMLP_UTILS_H
#define SMMLP_UTILS_H
...
// Derivative of linear function
    ...
    private:
        void AddNewPair(std::string function_name,
            ...
            activation_functions_map.insert(std::make_pair(function_name, std::make_pair(function, deriv_function)));
        };
    ...
    struct gen_rand {
        ...
        double offset;
    public:
        explicit gen_rand(double r = 2.0) : factor(r / RAND_MAX), offset(r / 2) {}
