...
Layer::Layer(int num_inputs_per_node,
             int num_nodes,
...
void Layer::GetOutputAfterActivationFunction(const std::vector<double> &input,
...
void Layer::UpdateWeights(const std::vector<double> &input_layer_activation,
...
void Layer::SaveLayer(FILE *file) const {
